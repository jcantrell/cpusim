...
void mmix::step(int inst)
{
  ...
  switch (inst)
  {
      ...
      case BDIFI: // b($X) <- b($Y) .- b(Z)
        {
        unsigned long long int b0 = ((R(y)>> 0)&0xFF) - ((z>> 0)&0xFF);
        unsigned long long int b1 = ((R(y)>> 8)&0xFF) - ((z>> 8)&0xFF);
        unsigned long long int b2 = ((R(y)>>16)&0xFF) - ((z>>16)&0xFF);
        unsigned long long int b3 = ((R(y)>>24)&0xFF) - ((z>>24)&0xFF);
        unsigned long long int b4 = ((R(y)>>32)&0xFF) - ((z>>32)&0xFF);
        unsigned long long int b5 = ((R(y)>>40)&0xFF) - ((z>>40)&0xFF);
        unsigned long long int b6 = ((R(y)>>48)&0xFF) - ((z>>48)&0xFF);
        unsigned long long int b7 = ((R(y)>>56)&0xFF) - ((z>>56)&0xFF);
        b0 = (b0 < 0) ? 0 : b0;
        b1 = (b1 < 0) ? 0 : b1;
        b2 = (b2 < 0) ? 0 : b2;
        b3 = (b3 < 0) ? 0 : b3;
      ...
      case WDIFI: // w($X) <- w($Y) - w(Z)
        {
        unsigned long long int w0 = ((R(y)>> 0)&0xFFFF) - ((z>> 0)&0xFFFF);
        unsigned long long int w1 = ((R(y)>>16)&0xFFFF) - ((z>>16)&0xFFFF);
        unsigned long long int w2 = ((R(y)>>32)&0xFFFF) - ((z>>32)&0xFFFF);
        unsigned long long int w3 = ((R(y)>>48)&0xFFFF) - ((z>>48)&0xFFFF);
        w0 = (w0 < 0) ? 0 : w0;
        w1 = (w0 < 0) ? 0 : w1;
        w2 = (w0 < 0) ? 0 : w2;
        w3 = (w0 < 0) ? 0 : w3;
      ...
      case TDIFI: // t($X) <- t($Y) - w(Z)
        {
        unsigned long long int t0 = ((R(y)>> 0)&0xFFFFFFFF) - ((z>> 0)&0xFFFFFFFF);
        unsigned long long int t1 = ((R(y)>>32)&0xFFFFFFFF) - ((z>>32)&0xFFFFFFFF);
        t0 = (t0 < 0) ? 0 : t0;
        t1 = (t1 < 0) ? 0 : t1;
        R(x, (t1<<32)&(t0<<0) );
        }
